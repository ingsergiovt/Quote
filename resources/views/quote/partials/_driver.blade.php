    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="dui_dwi_7_years_yes" name="dui_dwi_7_years" class="custom-control-input" value="yes" checked>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <div class="custom-control custom-check custom-control-inline">
                <input type="checkbox" id="dui_dwi_7_years_yes" name="dui_dwi_10_years" class="custom-control-input" value="yes">
                <label class="custom-control-label" for="dui_dwi_7_years_yes">Yes</label>
            </div>
            <div class="invalid-feedback">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="license_revoked_yes" name="license_revoked" class="custom-control-input" value="yes" checked>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="require_sr22_yes" name="require_sr22" class="custom-control-input" value="yes" checked>
